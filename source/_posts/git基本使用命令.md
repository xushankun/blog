...
![git-branch-1.png](https://github.com/xushankun/workspace/blob/master/blogImg/gitImg/git-branch1.png?raw=true)
```
git branch -a

git branch --set-upstream-to=remotes/origin/master master
```
![git-branch-2.png](https://github.com/xushankun/workspace/blob/master/blogImg/gitImg/git-branch2.png?raw=true)
